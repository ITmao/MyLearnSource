...
public class TestCRUDByXmlMapper {
    ...
    public void testAdd(){
         ...
         */
        String statement = "com.mybatis.mapping.usersMapper.addUser";//映射sql的标识字符串
    ...
    public void testUpdate(){
         ...
         */
        String statement = "com.mybatis.mapping.usersMapper.updateUser";//映射sql的标识字符串
        Users user = new Users();
        user.setId(3);
        user.setName("孤傲苍狼");
        user.setAge(25);
    ...
    public void testDelete(){
         ...
         */
        String statement = "com.mybatis.mapping.usersMapper.deleteUser";//映射sql的标识字符串
        //执行删除操作
    ...
    public void testGetAll(){
         ...
         */
        String statement = "com.mybatis.mapping.usersMapper.getAllUsers";//映射sql的标识字符串
