...
public class BizSecurity {
	...
	public final static String key1 = "hs";
	public final static String key2 = "club";
	public final static String key3 = "33#44";

	/**
	 * 3DES加密字符串
	 * 
	 * @param data	要加密的字符<br>
	 * 
	 * @param firstKey	第一个密钥<br>
	 * 	
	 * @param secondKey 第二个密钥<br>
	 * 
	 * @param thirdKey  第三个密钥<br>
	 * @return<br>
	 */
    public  static String desEncrypt(String data, String firstKey, String secondKey,
            String thirdKey) {
    	if(null== data ){
    		throw new IllegalArgumentException("data can not be null");
    	}
    	
    	if(null== firstKey || "".equals(firstKey)){
    		throw new IllegalArgumentException("key can not be null");
    	}
    	if(null== secondKey || "".equals(secondKey)){
    		throw new IllegalArgumentException("key can not be null");
    	}
    	if(null== thirdKey || "".equals(thirdKey)){
    		throw new IllegalArgumentException("key can not be null");
    	}
	 ...
	 * @return<br>
	 */
    public  static String desDecrypt(String data, String firstKey, String secondKey,
            String thirdKey) {
    	if(null== data ){
    		throw new IllegalArgumentException("data can not be null");
    	}
